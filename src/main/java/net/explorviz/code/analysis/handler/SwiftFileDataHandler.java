...
/**
 * FileData handler for Swift source files.
 */
public class SwiftFileDataHandler extends AbstractFileDataHandler
  ...
  public SwiftFileDataHandler(final String fileName) {
    super(fileName);
  ...
  public FileData getProtoBufObject() {
    ...
    builder.setLanguage(Language.SWIFT);
